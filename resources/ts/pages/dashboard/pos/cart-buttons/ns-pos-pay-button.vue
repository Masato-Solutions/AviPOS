<template>
    <div @click="payOrder()" id="pay-button" class="flex-shrink-0 w-1/5 flex items-center font-bold cursor-pointer justify-center bg-green-500 text-white hover:bg-green-600 border-r border-green-600 flex-auto">
