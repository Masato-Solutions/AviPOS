        ...
        return fields.map( field => {
            ...
            if ( field.type === 'custom' && typeof field.component === 'string' ) {
                ...
                if ( field.component ) {
                    ...
                    throw `Failed to load a custom component. "${componentName}" is not provided as an extra component. More details here: https://pos.avrinalanka.com/en/documentation/developpers-guides/how-to-register-a-custom-vue-component`;
                }
            }
