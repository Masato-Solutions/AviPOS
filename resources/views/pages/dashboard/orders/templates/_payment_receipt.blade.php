        ...
        <div class="table w-full">
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" class="font-bold p-2 border-b border-gray-800 text-sm font-semibolld">{{ __( 'Current Payment' ) }} : {{ $paymentTypes[ $payment[ 'identifier' ] ] ?? __( 'Unknown Payment' ) }}</td>
